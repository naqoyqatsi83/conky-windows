...
template <>
struct fmt::formatter<conky::info::display_session> : fmt::formatter<std::string_view> {
  auto format(conky::info::display_session session, fmt::format_context &ctx) const {
